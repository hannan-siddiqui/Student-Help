  ...
  return (
    <div className="px-4 ">
        ...
        <div className="flex items-center justify-start" >
            <div className="flex justify-start items-center w-[40%] mr-10">{data.question_title}</div>
            <div className="flex justify-center items-center w-[12%] mr-5 ">
                <Link to = {data.cs_link}>{
                    data.cs_link?<img className="w-8 h-8"
                    src="https://takeuforward-content-images.s3.ap-south-1.amazonaws.com/content/codestudio-ZJxLZjiy" alt="" />:null
                }</Link>
            </div>
            
            <div className="flex justify-center items-center w-[12%] mr-5 0" >
              
                    <Link to = {data.lc_link}>{data.lc_link?< LEETCODELOGO/>:null}</Link>
            ...
            
            {
               ...
               data.difficulty===0?
               <div className="bg-green-950 rounded-2xl  px-2"> 
               <div className=" text-green-500 font-semibold ">Easy</div>
               </div>

               :data.difficulty===1?
               
               <div className="bg-yellow-950 rounded-2xl px-2" >
                <div className="text-yellow-500">Medium</div>
               </div>
               
               :

               <div className="bg-red-950 rounded-2xl px-2"> 
