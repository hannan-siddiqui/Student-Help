...
const Footer = () => {
  ...
  return (
    <div className='bg-neutral-500 py-[5%] my-[1%] border-[4px] p border-black rounded-lg'>
...
<div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8  ">
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
        ...
        <span className="ml-2 text-xl font-bold tracking-wide text-black uppercase">Student-Help</span>
      </a>
      <div className="mt-6 lg:max-w-sm">
        <p className="text-sm text-gray-800">
        Gear Up for Success: Your Ultimate Preparation Hub! <br></br> 
        Navigate Your Learning Adventure: Explore DSA and Ace Interviews Effortlessly
        </p>
    ...
    <div className="space-y-2 text-sm">
      ...
      <div className="flex">
        ...
        <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">+91-9982972718</a>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800">Email:</p>
        <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">studenthelp@gmail.com</a>
      </div>
      <div className="flex">
        ...
        <a href="https://www.google.com/maps" target="_blank" rel="noopener noreferrer" aria-label="Our address" title="Our address" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">
          Habib Hall, Room No : 88 <br /> Aligarh Muslim University
        </a>
      </div>
    </div>
    <div>
      ...
      <div className="flex items-center mt-1 space-x-3">
        <a href="https://github.com/hannan-siddiqui" className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
  ...
  <div className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row">
    ...
    &copy; Copyright 2024 Student-Help All rights reserved.
    </p>
